...
function checkForWins() {
  ...
  // If the user has sunk all of the computer's ships, display a winning message in the info display and end the game
  if ((destroyerCount + submarineCount + cruiserCount + battleshipCount + carrierCount) === 50) {
    infoDisplay.innerHTML = "YOU WIN"
    gameOver()
  }
   // If the condition is true, display "COMPUTER WINS" on the info display.

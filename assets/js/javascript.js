...
// https://codepen.io/deepakkadarivel/pen/LrGEdL is where I found the code
  window.onload = function() {
    // find the element that you want to drag.
    var box = document.getElementById('grid-display');
    ...
    box.addEventListener('touchend', function(e) {
      ...
      var x = parseInt(grid-display.style.left);
      var y = parseInt(grid-display.style.top);
    })
